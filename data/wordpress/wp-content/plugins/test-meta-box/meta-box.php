...
class Meta
{
  ...
  public function display_form($post)
  {
    ...
    <table class="form-table">
      <tbody>
      <tr>
        <th scope="row"><label for="seo-title">mon titre</label></th>
        <td><input type="text" id="seo-title" name="seo-title" value="<?= esc_html($title) ?>" class="regular-text">
        </td>
      </tr>
      <tr>
        <th scope="row"><label for="seo-desc">mon Meta desc</label></th>
        <td><input type="text" id="seo-desc" name="seo-desc" value="<?= esc_html($title) ?>" class="regular-text">
        </td>
      </tr>
      </tbody>
    </table>
  ...
  public function save_form($post_id)
  {
    ...
    update_post_meta($post_id, 'seo-desc', sanitize_text_field($_POST['seo-desc']));
  }
